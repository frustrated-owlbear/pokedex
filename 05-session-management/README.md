...
Workshop stage 5: Session management for the Agentic RAG Pokédex — persistent play sessions, categorized observations, semantic session search, and LLM-generated session summaries.
