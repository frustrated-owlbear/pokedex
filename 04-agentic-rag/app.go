...
import (
	...
	"github.com/frustrated-owlbear/pokedex/04-agentic-rag/internal/agent"
...
func NewApp(cfg config.Config) (*App, error) {
	...
	sessionStore, err := session.NewStore(embedder)
	if err != nil {
		return nil, err
	}
	...
	agentLoop := agent.NewLoop(client, registry, cfg.AgentMaxIterations, sessionStore)
